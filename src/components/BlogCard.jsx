  ...
  return (
    <div>
        ...
        <Link to={`/blogs/${blog.id}`} key={blog.id} className={` ${blog.id % 2 === 0 ? 'flex-row-reverse' : ''}`}>
            <div className={` lg:min-w-[45rem] md:w-[30rem] bg-light font-serif rounded p-2 px-4 space-y-2 flex-1`}>
                ...
                <div className='font-serif text-2xl md:text-3xl font-semibold overflow-hidden whitespace-nowrap'>
                    {blog.title}
                </div>
